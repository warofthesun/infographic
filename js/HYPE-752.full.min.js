...
Ye=".HYPE_scene ",Ze=".Matrix(M11=",$e=".gradient(startColorstr=#00FFFFFF,endColorstr=#00FFFFFF)",af=".png",bf="/",cf="0",Rf="0 0 ",Sf="0%",Tf="0.0",Uf="0123456789ABCDEF",Vf="0px",Wf="1",Xf="1.0",Yf="100",Zf="100%",$f="50%",ag="600px",bg=": ",cg="</defs>",dg="</div>",eg="</linearGradient>",fg="</pattern>",gg="</style>",hg="</svg>",ig="<defs>",jg="<div style='overflow:auto;-webkit-overflow-scrolling:touch;width:100%;height:100%;'>",kg="<embed src='infographicheader.hyperesources/",lg="<iframe frameBorder='0'style='width:100%;height:100%;border:none' allowfullscreen='true'></iframe>",
